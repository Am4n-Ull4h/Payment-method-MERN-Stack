  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (isSignIn) {
          // Extract isAdmin from login response
          const { isAdmin, ...userData } = data;

          // Update user details in context with isAdmin field
          userDetails.updateUserDetails({ ...userData, isAdmin }, () => {
            // Log user details context after it's updated
            console.log("User details context:", userDetails.userDetails);
            // Redirect to '/welcome' route upon successful sign-in
            navigate('/welcome');
          });
        }
